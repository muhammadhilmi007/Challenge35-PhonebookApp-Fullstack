   ...
   const loadContacts = useCallback(async (loadMore = false) => {
     ...
     try {
       ...
       if (Array.isArray(phonebooks)) {
         setContacts(prev => loadMore ? [...prev, ...phonebooks] : phonebooks);
...
7. **Alur Proses Lengkap**
   ...
   - Alur Proses Keseluruhan:
     ...
     2. Pengurutan:
       ...
       2. `handleSortChange` dipanggil setiap perubahan input
       3. State pengurutan diperbarui di useContacts
       4. Data diambil dari API dengan parameter pengurutan
       5. Hasil ditampilkan di daftar kontak

     3. Infinite Scroll:
       1. User melakukan scroll ke bawah
       2. `handleScroll` dipanggil saat user melakukan scroll
       3. `loadMore` dipanggil untuk memuat kontak berikutnya
       4. Data diambil dari API dengan parameter halaman
       5. Hasil ditampilkan di daftar kontak

     4. Menambah Kontak:
       1. User menekan tombol "Add Contact"
       2. `handleAdd` dipanggil untuk navigasi ke halaman AddContact
       3. Komponen AddContact ditampilkan
       4. User mengisi form dan menekan tombol "Save"
       5. `handleSubmit` dipanggil untuk menyimpan kontak baru
       6. Data dikirim ke API untuk disimpan
       7. Hasil ditampilkan di daftar kontak

     5. Mengedit Kontak:
       1. User menekan tombol "Edit" pada kontak
       2. `handleEdit` dipanggil untuk navigasi ke halaman EditContact
       3. Komponen EditContact ditampilkan
       4. User mengisi form dan menekan tombol "Save"
       5. `handleSubmit` dipanggil untuk menyimpan perubahan kontak
       6. Data dikirim ke API untuk disimpan
       7. Hasil ditampilkan di daftar kontak

     6. Menghapus Kontak:
       1. User menekan tombol "Delete" pada kontak
       2. `handleDelete` dipanggil untuk menghapus kontak
       3. Data dikirim ke API untuk dihapus
       4. Hasil ditampilkan di daftar kontak

     7. Memperbarui Avatar Kontak:
       1. User menekan tombol "Update Avatar" pada kontak
       2. `handleAvatarUpdate` dipanggil untuk navigasi ke halaman AvatarUpload
       3. Komponen AvatarUpload ditampilkan
       4. User mengisi form dan menekan tombol "Save"
       5. `handleSubmit` dipanggil untuk menyimpan perubahan avatar kontak
       6. Data dikirim ke API untuk disimpan
       7. Hasil ditampilkan di daftar kontak

     8. Error Handling:
       1. Kesalahan saat memuat data
       2. Kesalahan saat menyimpan perubahan kontak
       3. Kesalahan saat menghapus kontak
       4. Kesalahan saat memperbarui avatar kontak

     9. Routing:
       1. Pengguna diarahkan ke halaman utama
       2. Pengguna diarahkan ke halaman AddContact
       3. Pengguna diarahkan ke halaman EditContact
       4. Pengguna diarahkan ke halaman AvatarUpload

     10. Optimasi Performa:
       1. Implementasi infinite scroll untuk memuat kontak secara bertahap
       2. Pencarian dan pengurutan dilakukan secara lokal untuk UX yang lebih responsif

     11. Penjelasan Fungsi:
       1. `useContacts` untuk memuat data kontak
       2. `handleSearchChange` untuk mengubah pencarian
       3. `handleSortChange` untuk mengubah pengurutan
       4. `handleScroll` untuk memuat kontak berikutnya
       5. `handleAdd` untuk navigasi ke halaman AddContact
       6. `handleEdit` untuk navigasi ke halaman EditContact
       7. `handleDelete` untuk menghapus kontak
       8. `handleAvatarUpdate` untuk navigasi ke halaman AvatarUpload
      
      12. Penjelasan Komponen:
       1. SearchBar: Input pencarian dan tombol pencarian
       2. ContactList: Daftar kontak yang dapat di-edit, dihapus, dan memperbarui avatar kontak
       3. ContactCard: Card kontak yang dapat di-edit, dihapus, dan memperbarui avatar kontak
       4. AvatarUpload: Form untuk memperbarui avatar kontak

      13. Penjelasan fungsi pada React JS:
       1. useEffect: Menggunakan useEffect untuk memuat data kontak
       2. useState: Menggunakan useState untuk mengelola state
       3. useMemo: Menggunakan useMemo untuk menyimpan data kontak
       4. useCallback: Menggunakan useCallback untuk menyimpan fungsi
       5. useSessionStorage: Menggunakan useSessionStorage untuk menyimpan preferensi pengguna
       6. useNavigate: Menggunakan useNavigate untuk navigasi antar halaman
       7. useInfiniteScroll: Menggunakan useInfiniteScroll untuk memuat kontak secara bertahap
       8. useSearch: Menggunakan useSearch untuk pencarian
       9. useSort: Menggunakan useSort untuk pengurutan
       10. useDebounce: Menggunakan useDebounce untuk debouncing pencarian
       11. useScroll: Menggunakan useScroll untuk memuat kontak berikutnya
       12. useAvatar: Menggunakan useAvatar untuk mengunggah avatar kontak
